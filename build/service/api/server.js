...
var AddUserApi = require("./AddUser");
...
module.exports = /** @class */ (function () {
    function AppApiServer(userDb, turnServer) {
        var _this = this;
        this.endpoints = function (app) {
            app.post('/addUser', function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    ...
    AppApiServer.prototype.createServer = function () {
        var _this = this;
        var app = express();
        app.use(express.json());
        this.endpoints(app);
        var restServer = app.listen(8081, function () {
            var host = restServer.address().address;
            var port = restServer.address().port;
            _this.logger.info("Example app listening at http://".concat(host, ":").concat(port));
        });
    };
    return AppApiServer;
}());
